    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          @guest
                            @if (Route::has('login'))
<a class="nav-link nav-profile d-flex align-items-center pe-0" href="{{ route('login') }}" data-bs-toggle="dropdown">
            LOGIN</span>
          </a><!-- End Profile Iamge Icon -->
                                @endif
                        @else
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{asset('/themes/assets/img/profile-img.jpg')}}" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ url('/admin/company_types/') }}">
              <i class="bi bi-circle"></i><span>Company Type</span>
            </a>
          </li>
          <li>
  ...
  <script src="{{ asset('/themes/assets/vendor/chart.js/chart.min.js')}}"></script>
