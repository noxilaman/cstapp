 ...
 @section('content')
     <div class="content-wrapper">
         <h3>ตั้งรหัสผ่านใหม่ ของโรงแรม {{ $company->name }}</h3>
         <label for="">ไม่น้อยกว่า 6 ตัวอักขระ และไม่มากกว่า 20 ตัวอักขระ</label>
         <div class="row">
             <form action="{{ url('company/changepassAction/' . $company->id) }}" class="forms-sample" method="POST"
                 ...
                 <div class='row'>
                     <div class="form-group col-6">
                         ...
                         <input type="password" class="form-control" id="newpass" placeholder="" name='newpass'
                             value=''>
                             @error('newpass')
      <div class="alert alert-danger">รหัสผ่านใหม่</div>
      @enderror
                     </div>
                     <div class="form-group col-6">
      ...
      <div class="alert alert-danger">รหัสผ่านใหม่อีกครั้ง</div>
      @enderror
                     </div>
                 </div>
                 <div class='row'>
